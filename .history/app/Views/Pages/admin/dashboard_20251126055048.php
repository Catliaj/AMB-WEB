...
<body class="dashboard-page" style="background:var(--bg);">
  ...
  <section class="main">
    ...
    <div class="content">
      <div class="cards">
      <div class="combined-card" style="display: flex; gap: 20px; justify-content: space-around; background: var(--card); padding: 20px; border-radius: 12px; flex-wrap: wrap;">
        <div class="metric" style="display: flex; flex-direction: column; align-items: center; min-width: 100px;">
          <h2 style="font-weight: 600; font-size: 0.9rem;">Total Users</h2>
          <div class="value" style="display: flex; align-items: center; gap: 6px; font-size: 2rem; font-weight: 700;"><i data-lucide="users" style="width: 18px; height: 18px;"></i><span id="totalUsers"></span></div>
        </div>
        <div class="metric" style="display: flex; flex-direction: column; align-items: center; min-width: 100px;">
          <h2 style="font-weight: 600; font-size: 0.9rem;">Total Properties</h2>
          <div class="value" style="display: flex; align-items: center; gap: 6px; font-size: 2rem; font-weight: 700;"><i data-lucide="home" style="width: 18px; height: 18px;"></i><span id="totalProperties">0</span></div>
        </div>
        <div class="metric" style="display: flex; flex-direction: column; align-items: center; min-width: 100px;">
          <h2 style="font-weight: 600; font-size: 0.9rem;">Total Bookings</h2>
          <div class="value" style="display: flex; align-items: center; gap: 6px; font-size: 2rem; font-weight: 700;"><i data-lucide="calendar" style="width: 18px; height: 18px;"></i><span id="totalBookings">0</span></div>
        </div>
        <div class="metric" style="display: flex; flex-direction: column; align-items: center; min-width: 100px;">
          <h2 style="font-weight: 600; font-size: 0.9rem;">Pending bookings</h2>
          <div class="value" style="display: flex; align-items: center; gap: 6px; font-size: 2rem; font-weight: 700;"><i data-lucide="clock" style="width: 18px; height: 18px;"></i><span id="pendingBookings">0</span></div>
        </div>
        <div class="metric" style="display: flex; flex-direction: column; align-items: center; min-width: 100px;">
          <h2 style="font-weight: 600; font-size: 0.9rem;">Agent assignments</h2>
          <div class="value" style="display: flex; align-items: center; gap: 6px; font-size: 2rem; font-weight: 700;"><i data-lucide="user-check" style="width: 18px; height: 18px;"></i><span id="agentAssignments">0</span></div>
        </div>
      </div>
      </div>

      <div class="main-row" style="display: flex; flex-direction: row; gap: 10px; flex-wrap: wrap; margin-top: -40px;">
          <div class="chart-card" style="flex: 1 1 280px; padding: 10px;">
            <h3><button class="drag-handle" aria-label="Drag to reorder" title="Drag to reorder"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M7 9h2M7 13h2M11 9h2M11 13h2M15 9h2M15 13h2" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></button><i data-lucide="line-chart"></i> Booking Trend</h3>
            <div class="chart-container resizable" data-chart="bookingChart"><canvas id="bookingChart"></canvas><button class="resizer" aria-label="Resize chart" title="Resize"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M16 16l4 4M11 16l9 0M6 16l10 0" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></button></div>
          </div>
          <div class="chart-card" style="flex: 1; padding: 10px;">
            <h3><button class="drag-handle" aria-label="Drag to reorder" title="Drag to reorder"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M7 9h2M7 13h2M11 9h2M11 13h2M15 9h2M15 13h2" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></button><i data-lucide="pie-chart"></i> Property Distribution</h3>
            <div class="chart-container resizable" data-chart="propertyChart"><canvas id="propertyChart"></canvas><button class="resizer" aria-label="Resize chart" title="Resize"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M16 16l4 4M11 16l9 0M6 16l10 0" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></button></div>
          </div>
          <div class="chart-card" style="flex: 1; padding: 10px;">
            <h3><button class="drag-handle" aria-label="Drag to reorder" title="Drag to reorder"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M7 9h2M7 13h2M11 9h2M11 13h2M15 9h2M15 13h2" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></button><i data-lucide="scatter-chart"></i> Sold Properties</h3>
            <div class="chart-container resizable" data-chart="soldScatterChart"><canvas id="soldScatterChart"></canvas><button class="resizer" aria-label="Resize chart" title="Resize"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M16 16l4 4M11 16l9 0M6 16l10 0" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></button></div>
          </div>
        </div>
        ...
        if (window.Chart) {
          ...
          const bookingCanvas = document.getElementById("bookingChart");
            ...
            if (propertyCanvas && bookingCanvas) {
              ...
              // Sold scatter plot chart JS
              const soldScatterCanvas = document.getElementById("soldScatterChart");
              if (soldScatterCanvas) {
                soldScatterCanvas.style.width = '100%';
                soldScatterCanvas.style.height = '100%';
                const soldScatterCtx = soldScatterCanvas.getContext("2d");
                // Dummy data points for Sold scatter plot
                const soldScatterData = [
                  { x: 10, y: 20 },
                  { x: 15, y: 10 },
                  { x: 7, y: 25 },
                  { x: 20, y: 15 },
                ...
                new Chart(soldScatterCtx, {
                  type: 'scatter',
                  data: {
                    datasets: [{
                      label: 'Sold Data Points',
                      data: soldScatterData,
                      backgroundColor: cAccent3,
                      borderColor: cAccent3,
                      pointRadius: 6
                    }]
                  },
                  options: {
                    ...
                    plugins: {
                      legend: { labels: { color: css.getPropertyValue('--text').trim() || '#ccc', font: { size: 12 } }, position: "bottom" }
                    }
                  }
                });
              }
          ...
          try {
            ...
            function makeResizer(container){
              ...
              const onPointerMove = (e) => {
                ...
                const minW = 200;
                const chartsArea = container.closest('.main-row')?.getBoundingClientRect() || { width: window.innerWidth };
