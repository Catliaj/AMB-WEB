    ...
    <div class="modal-dialog modal-dialog-centered modal-md">
      <div class="modal-content">
        ...
        <form id="editBookingForm">
          <div class="modal-body">
            <input type="hidden" id="editBookingId" name="bookingID" readonly>
            <div class="mb-3">
              <label for="editClientName" class="form-label">Client Name</label>
              <input type="text" id="editClientName" name="ClientName" class="form-control" required>
            </div>
            <div class="mb-3">
              <label for="editPropertyTitle" class="form-label">Property</label>
              <input type="text" id="editPropertyTitle" name="PropertyTitle" class="form-control" required>
            </div>
            <div class="mb-3">
              <label for="editBookingDate" class="form-label">Date</label>
              <input type="date" id="editBookingDate" name="BookingDate" class="form-control" required>
            </div>
            <div class="mb-3">
