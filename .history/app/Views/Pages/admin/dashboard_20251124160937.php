...
<body class="dashboard-page" style="background:var(--bg);">
  ...
  <section class="main">
    ...
    <div class="content">
      ...
      <div class="main-row" style="display: flex; flex-direction: row; gap: 10px; flex-wrap: wrap; margin-top: -30px;">
          <div class="chart-card" style="flex: 1; padding: 10px;">
            <h3><i data-lucide="line-chart"></i> Booking Trend</h3>
            <div class="chart-container resizable" data-chart="bookingChart"><canvas id="bookingChart"></canvas></div>
          </div>
          <div class="chart-card" style="flex: 1; padding: 10px;">
