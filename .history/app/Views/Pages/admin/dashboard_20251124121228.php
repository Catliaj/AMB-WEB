...
<body class="dashboard-page" style="background:var(--bg);">
  ...
  <section class="main">
    ...
    <div class="content">
      <div class="cards">
        <div class="combined-card" style="display: flex; gap: 40px; justify-content: space-around; background: var(--card); padding: 30px; border-radius: 12px; flex-wrap: wrap;">
          <div class="metric" style="display: flex; flex-direction: column; align-items: center; min-width: 120px;">
            <h2 style="display: flex; align-items: center; gap: 6px; font-weight: 600; font-size: 1rem;">
              <i data-lucide="users" style="width: 20px; height: 20px;"></i> Total Users
            </h2>
            <div class="value" id="totalUsers" style="font-size: 2.2rem; font-weight: 700;"></div>
          </div>
          <div class="metric" style="display: flex; flex-direction: column; align-items: center; min-width: 120px;">
            <h2 style="display: flex; align-items: center; gap: 6px; font-weight: 600; font-size: 1rem;">
              <i data-lucide="home" style="width: 20px; height: 20px;"></i> Total Properties
            </h2>
            <div class="value" id="totalProperties" style="font-size: 2.2rem; font-weight: 700;">0</div>
          </div>
          <div class="metric" style="display: flex; flex-direction: column; align-items: center; min-width: 120px;">
            <h2 style="display: flex; align-items: center; gap: 6px; font-weight: 600; font-size: 1rem;">
              <i data-lucide="calendar" style="width: 20px; height: 20px;"></i> Total Bookings
            </h2>
            <div class="value" id="totalBookings" style="font-size: 2.2rem; font-weight: 700;">0</div>
          </div>
          <div class="metric" style="display: flex; flex-direction: column; align-items: center; min-width: 120px;">
            <h2 style="display: flex; align-items: center; gap: 6px; font-weight: 600; font-size: 1rem;">
              <i data-lucide="clock" style="width: 20px; height: 20px;"></i> Pending bookings
            </h2>
            <div class="value" id="pendingBookings" style="font-size: 2.2rem; font-weight: 700;">0</div>
          </div>
          <div class="metric" style="display: flex; flex-direction: column; align-items: center; min-width: 120px;">
            <h2 style="display: flex; align-items: center; gap: 6px; font-weight: 600; font-size: 1rem;">
              <i data-lucide="user-check" style="width: 20px; height: 20px;"></i> Agent assignments
            </h2>
            <div class="value" id="agentAssignments" style="font-size: 2.2rem; font-weight: 700;">0</div>
          </div>
        </div>
      </div>
      ...
      <div class="main-row">
          ...
          <div class="chart-card chart-bottom">
            <h3><i data-lucide="scatter-chart"></i> Sold Graph (Scatter Plot)</h3>
