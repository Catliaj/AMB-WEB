...
<body class="dashboard-page" style="background:var(--bg);">
  ...
  <section class="main">
    ...
    <div class="content">
      <div class="cards">
        <div class="combined-card" style="display: flex; gap: 20px; justify-content: space-around; background: var(--card); padding: 20px; border-radius: 12px;">
          ...
          <div class="metric" style="display: flex; flex-direction: column; align-items: center; min-width: 100px;">
            <h2 style="display: flex; align-items: center; gap: 6px; font-weight: 600; font-size: 1rem;">
              <i data-lucide="user-plus" style="width: 20px; height: 20px;"></i> New signups (24h)
            </h2>
            <div class="value" id="newSignups" style="font-size: 2rem; font-weight: 700;">12</div>
          </div>
          <div class="metric" style="display: flex; flex-direction: column; align-items: center; min-width: 100px;">
            <h2 style="display: flex; align-items: center; gap: 6px; font-weight: 600; font-size: 1rem;">
