  ...
  <section class="main">
    ...
    <div class="content">
      ...
      <div class="main-row" style="display: flex; flex-direction: row; gap: 10px; flex-wrap: wrap; margin-top: -40px;">
          ...
          <div class="chart-card" style="flex: 1; padding: 10px;">
            <h3><i data-lucide="scatter-chart"></i> Sold Properties</h3>
            <div class="chart-container resizable" data-chart="soldScatterChart"><canvas id="soldScatterChart"></canvas></div>
          </div>
        </div>
