    ...
    <div class="content">
      ...
      <div class="combined-card" style="display: flex; gap: 20px; justify-content: space-around; background: var(--card); padding: 20px; border-radius: 12px; flex-wrap: wrap;">
        <div class="metric" style="display: flex; flex-direction: column; align-items: center; min-width: 100px;">
          ...
          <div class="value" id="totalUsers" style="display: flex; align-items: center; gap: 6px; font-size: 2rem; font-weight: 700;"><i data-lucide="users" style="width: 18px; height: 18px;"></i></div>
        </div>
        <div class="metric" style="display: flex; flex-direction: column; align-items: center; min-width: 100px;">
          <h2 style="font-weight: 600; font-size: 0.9rem;">Total Properties</h2>
          <div class="value" id="totalProperties" style="display: flex; align-items: center; gap: 6px; font-size: 2rem; font-weight: 700;"><i data-lucide="home" style="width: 18px; height: 18px;"></i>0</div>
        </div>
        <div class="metric" style="display: flex; flex-direction: column; align-items: center; min-width: 100px;">
          <h2 style="font-weight: 600; font-size: 0.9rem;">Total Bookings</h2>
          <div class="value" id="totalBookings" style="display: flex; align-items: center; gap: 6px; font-size: 2rem; font-weight: 700;"><i data-lucide="calendar" style="width: 18px; height: 18px;"></i>0</div>
        </div>
        <div class="metric" style="display: flex; flex-direction: column; align-items: center; min-width: 100px;">
          <h2 style="font-weight: 600; font-size: 0.9rem;">Pending bookings</h2>
          <div class="value" id="pendingBookings" style="display: flex; align-items: center; gap: 6px; font-size: 2rem; font-weight: 700;"><i data-lucide="clock" style="width: 18px; height: 18px;"></i>0</div>
        </div>
        <div class="metric" style="display: flex; flex-direction: column; align-items: center; min-width: 100px;">
          <h2 style="font-weight: 600; font-size: 0.9rem;">Agent assignments</h2>
          <div class="value" id="agentAssignments" style="display: flex; align-items: center; gap: 6px; font-size: 2rem; font-weight: 700;"><i data-lucide="user-check" style="width: 18px; height: 18px;"></i>0</div>
        </div>
      </div>
      </div>
